  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className={`w-full flex items-center justify-between px-3 py-3 border-b border-stroke bg-transparent focus:border-waterloo focus:placeholder:text-black focus-visible:outline-none dark:border-strokedark dark:focus:border-manatee dark:focus:placeholder:text-white ${
        ...
        <div className="flex items-center gap-2">
          {selectedCountry ? (
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">
              {t('visa_application.general.select_country')}
            </span>
          )}
        </div>
        <svg
      ...
      {isOpen && (
        <div className="absolute z-50 w-full mt-1 bg-white dark:bg-gray-800 border border-stroke dark:border-strokedark rounded-lg shadow-lg max-h-64 overflow-hidden">
          <div className="p-3 border-b border-stroke dark:border-strokedark">
            <input
              type="text"
              placeholder={t('visa_application.general.search_country')}
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="w-full px-3 py-2 text-sm border border-stroke dark:border-strokedark rounded-md focus:outline-none focus:ring-2 focus:ring-primary dark:bg-gray-700 dark:text-white"
            />
          </div>
          <div className="max-h-48 overflow-y-auto">
            {filteredCountries.length > 0 ? (
              ...
              <div className="px-3 py-2 text-sm text-gray-500 dark:text-gray-400">
                {t('visa_application.general.no_country_found')}
              </div>
            )}
          </div>
        </div>
